// ============================================================
// WeatherNext Service Worker — Manchis (文积, Pahang)
// MIGRATED to the full Raub/Cameron microclimate architecture (was the older
// 1.0.155 forecast-only build, no boot screen — one is added here). Carries:
...
// coordinates (keeps Manchis name). Boot screen sky-blue (#9bd3f6) to match
// the graduate/orchard icon. Identity: namespace weathernextformanchis, appId
// wnext-ag-v41-weathernextformanchis, name Stanley Woo, 3 seed farms (Manchis /
// Kg. Ponson / Batu 36, c_mc- IDs preserved), seed version mc-arch1.
...
// with the refined Raub version. Manchis's own GPS sort order, seed farms,
// namespace, appId and all other code are UNCHANGED — only the broadcast text
// logic was swapped. Fixes carried over:
...
const CACHE_VERSION = 'wnext-weathernextformanchis-202606062249';
