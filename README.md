...
plantation locations around Manchis (文积), Pahang. Bilingual interface
...
```
wnext-weathernextformanchis-202605280140
```
...
- **Storage namespace:** `weathernextformanchis__*` keys in `localStorage`,
